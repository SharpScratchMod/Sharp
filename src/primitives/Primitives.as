...
public class Primitives {
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		primTable["convertUnicode"]				= function(b:*):* { return ("interp.arg(b, 0)").charCodeAt(0) - 40 };
		primTable["convertString"]				= function(b:*):* { return String.fromCharCode(interp.arg(b, 0)) };
	...
	function primLetterOf(b:Block):String {
	...
	function primModulo(b:Block):Number {
	...
	function primMathFunction(b:Block):Number {
	...
	var lcDict:Dictionary = new Dictionary();
	function compare(a1:*, a2:*):int {
		// This is so it can be used by the list "contains" primitive.
	...
	function primCreateCloneOf(b:Block):void {
	...
	function primDeleteClone(b:Block):void {
